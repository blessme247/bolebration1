...
import food6 from "../../assets/Images/menu6.png"

export const foodTray = [
    {id : "f1", name: "Plantain Boat", price: "₦1,000", imageSrc: food1},
    {id : "f2", name: " Bole and Chicken", price: "₦2,500", imageSrc: food2},
    {id : "f3", name: " Bole and Turkey", price: "₦3,000", imageSrc: food3},
    {id : "f4", name: "Bole and Mackerel fish", price: "₦3,500", imageSrc: food4},
    {id : "f5", name: "Bole and Whole Croaker fish Bole and Turkey", price: "₦6,000", imageSrc: food5},
