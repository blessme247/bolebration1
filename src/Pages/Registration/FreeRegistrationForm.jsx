...
const FreeRegistrationForm = ({ticketCount, setTicketCount}) => {
  ...
  return (
      ...
      <div className='formWrapper'>
        ...
        <p className="formBrief">Be one of the <span> lucky 1,500 </span>  people to get a free ticket</p>
        ...
        initialValues={{
          ...
          onSubmit={async (values, { setSubmitting, resetForm}) => {
            ...
            //   position: 'center',
            //   icon: 'success',
            //   title: 'Registration successful, kindly check your email for your ticket.',
        ...
        <div className="maleRadioGroup">
          <Field type="radio" name="gender" value="male" onClick={setMale("male")} />
          <label htmlFor="male">Male</label>
          </div>

          <div className="femaleRadioGroup">
          <Field type="radio" name="gender" value="female" onClick={setFemale("female")}  />
          <label htmlFor="female">Female</label>
            ...
            <button disabled={isSubmitting}
                    type="button"
                    onClick={handleSubmit} className='registerBtn'>
                Register
            </button>
